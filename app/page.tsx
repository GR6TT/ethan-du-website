...
const milestoneCards = [
  {
    ...
    titleZh: "BYU–Idaho",
    titleEn: "BYU–Idaho",
    bodyZh: "计算机科学 · 4.0GPA · 2028",
    bodyEn: "Computer Science · 4.0 GPA · 2028",
...
const identityCards = [
  ...
  },
  {
    ...
    image: "/neweic-quant-official.webp",
    imageClass: "neweic",
...
const mediaCards = [
  ...
  },
  {
    ...
    titleZh: "财联社&科创板日报：杜易展执委Eagle创投俱乐部支持科创板开市五周年峰会举办",
    ...
    bodyZh: "杜易展所任执委的Eagle创投俱乐部为2024科创板开市五周年峰会的支持单位，杜易展代表并参与支持活动举办。",
